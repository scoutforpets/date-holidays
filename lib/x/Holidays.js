...
Holidays.prototype = {
   ...
   */
  moveToTimezone: function moveToTimezone(date, timezone) {
   ...
   * ```
   */
  getRegions: function getRegions(country, state) {
   ...
   */
  _disable: function _disable(date, disableDates, enableDates) {
    var i;
    var flag;
    var d;
    var diff;
