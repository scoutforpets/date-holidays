...
var grammar = function () {
  ...
  raw.jewish = replace(raw.jewish, '')(/_jewishMonths/, raw._jewishMonths)();
  raw.date_equinox = replace(raw.date_equinox, '')(/_counts/, raw._counts)(/_days/g, raw._days)(/_direction/g, raw._direction)();
  raw.date_bridge_day = replace(raw.date_bridge_day)(/_date/g, raw._date)();
  raw.day_dir_date = replace(raw.day_dir_date, '')(/_counts/, raw._counts)(/_days/g, raw._days)(/_direction/g, raw._direction)(/_date/, raw._date)();
  raw.date_if_then = replace(raw.date_if_then, '')(/_date/, raw._date)(/_islamic/, raw.islamic)(/_direction/g, raw._direction)(/_weekdays/g, raw._weekdays)(/_days/g, raw._days)();
  raw.time = replace(raw.time, '')(/_days/, raw._days)(/_time/g, raw._time)();
  raw.date = replace(raw.date)(/_date/, raw._date)();
  /* eslint-enable */
...
var parseFn = {
  ...
  dateBridge: function dateBridge(o) {
    var cap;
    var res;
  ...
  dateIfThen: function dateIfThen(o) {
    var cap;
    var res;
  ...
  dateIfEqual: function dateIfEqual(o) {
    var cap;
    var res;
    ...
    function parse(o) {
      var res;
      /*eslint-disable*/
      if (res = parseFn.easter(o)) {} else if (res = parseFn.dateDir(o)) {} else if (res = parseFn.date(o)) {}
      /*eslint-enable*/
      return res;
    }
  ...
  yearRule: function yearRule(o, res) {
    var cap;
  ...
  duration: function duration(o, res) {
    var cap;
...
function parser(str) {
  ...
  /*eslint-disable*/
  if (res = parseFn.dateIfEqual(o)) {} else if (res = parseFn.equinox(o)) {} else if (res = parseFn.dateBridge(o)) {} else if (res = parseFn.dateDir(o)) {} else if (res = parseFn.dateIfThen(o)) {} else if (res = parseFn.easter(o)) {} else if (res = parseFn.islamic(o)) {} else if (res = parseFn.jewish(o)) {} else if (res = parseFn.date(o)) {}
  /*eslint-enable*/
