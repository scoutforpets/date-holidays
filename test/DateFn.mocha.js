  ...
  describe('Movable Date', function () {
    ...
    describe('equinox', function () {
      it('spring equinox', function () {
        var fn = new DateFn('spring equinox')
        var res = fn.inYear(2015).get()
        var exp = [{
      ...
      it('spring equinox in Asia/Tokyo', function () {
        var fn = new DateFn('spring equinox in Asia/Tokyo')
        var res = fn.inYear(2015).get()
        var exp = [{
      ...
      it('3 days after autumn equinox', function () {
        var fn = new DateFn('3 days after autumn equinox')
        var res = fn.inYear(2015).get()
        var exp = [{
      ...
      it('1 day before summer solstice', function () {
        var fn = new DateFn('1 day before summer solstice')
        var res = fn.inYear(2015).get()
        var exp = [{
      ...
      it('3rd monday before winter solstice', function () {
        var fn = new DateFn('3rd monday before winter solstice')
        var res = fn.inYear(2015).get()
        var exp = [{
